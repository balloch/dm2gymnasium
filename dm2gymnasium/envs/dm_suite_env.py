...
class DMSuiteEnv(gym.Env):
    ...
    def step(self, action):
        ...
        truncated = False  # TODO balloch: this may need some dimension matching for vec environments
        info = {}
        return observation, reward, terminated, truncated, info
    
    def reset(self,seed=None):
        timestep = self.env.reset(seed)
        return timestep.observation, {}
    

    # Deprecated, don't really know what to do here yet, should go in "make"
